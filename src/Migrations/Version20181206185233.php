 ...
 */
final class Version20181206185233 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE partida (id INT AUTO_INCREMENT NOT NULL, descricao VARCHAR(255) NOT NULL, placar_visitante INT NOT NULL, placar_casa INT NOT NULL, data_partida DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
